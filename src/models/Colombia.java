...
public class Colombia {
	 ...
	 * @return
	 * Retorna el retorno de {@link #generateReportGain(int, Map)}.
	 */
	 ...
	 * @param counter
	 * Contador que almacena la posicion de la llamada recursiva.
	 * @param data
	 * Mapa con los datos del reporte.
	 * @return
	 * Retorna un vector de objetos que contiene una matriz con el grafico de barras y las convenciones.
	 */
	 ...
	 * Mapa con los datos del reporte.
	 * @param counter
	 * Contador que guarda la posicion de la llamada recursiva
	 * @return
	 * Retorna un vector de objetos que contiene una matriz con el grafico de barras y las convenciones.
	 */
	...
	/**
	 * Genera Reporte de metris cuadrados explotados por cada mina en un departamento especificado de manera recursiva.
	 * @param department
	 * Nombre del departamento en el caul se va a realizar el reporte.
	 * @param counter
	 * Contador que lleva el la posicion de la llamada recursiva.
	 * @param data
	 * Mapa con los datos del reporte.
	 * @return
	 * Retorna un vector de Objetos que contiene una matriz con el grafico de barras y las conveciones.
	 * @throws DepartmentNotFoundException
	 * La Excepcion es lanzada cuando el departamento especificado no es encontrado.
	 */
	public Object[] generateReportm2PerDepartment(DepartmentName department, int counter, Map<String, Integer> data) throws DepartmentNotFoundException {
		List<Mine> mine = listDepartment[searchDepartment(department)].getListMine();
	 ...
	 * @param counter
	 * Contador encargado de llevar la cuenta de en que posicion en cada llamado recursivo.
	 * @param data
	 * Mapa con los datos de la matriz
	 * @return
	 * Retorna un vectir de objetos que contiene una matrix con el grafico de barras y las convenciones.
	 */
