...
/**
 * la clase Department almacena y administra las minas por departamento.
 * 
...
public class Department {
	...
	/**
	 * Constructor encargado de dar valores a los atributos y de inicializar algunos datos.
	 * @param name
	 * Nombre del departamento 
	 * @param budgetDepartment
	 * Presupuesto del departamento.
	 * @throws MineNotFoundException
	 * De no ser  encontrada la mina por el id indicado, lanzara la excepcion.
	 */
	...
	/**
	 * Genera automaticamente de forma aleatoria algunos datos de las minas para cada departamento.
	 */
	...
	/**
	 * Metodo encargado de agregar una mina a la lista de minas del departamento.
	 * @param mine
	 * Mina que se quiere agregar en el listado del departamento.
	 */
	...
	/**
	 * Busca la posicion de una mina por su id en el listado de minas del departamento.
	 * @param id
	 * numero de identificacion de una mina.
	 * @return
	 * Retorna la posicion que ocupa cierta mina dentro de la lista de minas del departamento.
	 * @throws MineNotFoundException
	 * De no ser  encontrada la mina por el id indicado, lanzara la excepcion.
	 */
	 ...
	 * @param id
	 * numero de identificacion de la mina que se desea eliminar.
	 * @throws MineNotFoundException
	 * De no ser  encontrada la mina por el id indicado, lanzara la excepcion.
	 */
	 ...
	 * @param newType
	 * nuevo tipo de recurso que explota la mina. 
	 * @param id
	 * numero de identificacion de la mina que se quiere editar.
	 * @throws MineNotFoundException
	 * De no ser  encontrada la mina por el id indicado, lanzara la excepcion.
	 */
	// ----------------------------------------------------------------------------------//
	 ...
	 * @param price
	 * nuevo valor del mineral que explota la mina. 
	 * @param id
	 * numero de identificacion de la mina que se quiere editar.
	 * @throws MineNotFoundException
	 * De no ser  encontrada la mina por el id indicado, lanzara la excepcion.
	 ...
	 * @param idMine
	 * numero de identificacion de la mina que realizara la venta.
	 * @param kilos
	 * cantidad de kilos que vendera la mina.
	 * @throws MineNotFoundException
	 * De no ser  encontrada la mina por el id indicado, lanzara la excepcion.
