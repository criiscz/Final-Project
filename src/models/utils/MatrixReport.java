...
public class MatrixReport {
	 ...
	 * 
	 * @param values Array con los valores a evaluar
	 * @return Retorna el valor mayor entre todo el array.
	 */
	 ...
	 * 
	 * @param values valor maximo para determinar la altura.
	 * @param scale  Escala con la que se dibujara la matriz.
	 * @return Retorna la altura de la matriz.
	 */
	 ...
	 * 
	 * @param matrix         Matriz lista para dibujar la grafica de barras.
	 * @param values         Valores del eje X
	 * @param num            valores del eje Y
	 * @param counter        Valor de escala auxiliar
	 * @param option         Valor del encabezado del eje Y
	 * @param scale          Escala por la cual se cuadra la grafica.
	 * @param valueOfColumns Cantidad de columnas que tendra la grafica.
	 * @return Retorna una matriz con la grafica dibujada.
	 */
	private static String[][] generateGraphic(String[][] matrix, Object[] values, Object[] num, int counter,
			String option, int scale, int valueOfColumns) {
		int test = 1;
	 ...
	 * 
	 * @param names  Array con los nombres de los valores de las convenciones.
	 * @param values Array con los valores de las convenciones.
	 * @return Retorna las convenciones en una matriz de Strings.
	 */
