...
public class ControllerApp {
	...
	/**
	 * Constructor de la clase que se encarga de instanciar algunos objetos que
	 * necesitamos para poder ejecutar las opciones deseadas por el usuario y asi
	 * interactuar con el.
	 */
	...
	/**
	 * Metodo encargado de generar el menu principal del proyecto, en el que se
	 * muestran las opciones que se ofrecen al usuario.
	 */
	private void init() {
		// addMine();
	...
	/**
	 * Muestra mensaje de salida, cierra el programa.
	 */
	...
	/**
	 * Genera una tabla en la cual se muestran diferentes listados de departamentos
	 * con sus respectivas minas.
	 */
	...
	private void addMine() {
		try {
			model.createMine(view.readDepartment(), view.readNameMine(), view.readMeterMine(), view.readOreType(),
					view.readKilogram(), view.readMineType(), view.readBudgetMine());
			view.showSucesfull();
	...
	/**
	 * Permite editar datos especificos de una mina tales como el precio por Kg del
	 * mineral que explota o el tipo de mineral que explota.
	 * 
	 * @throws OptionInvalidException Excepcion que se presenta cuando el usuario
	 *                                ingresa una opcion que no es valida.
	 */
	...
	/**
	 * Genera un menu de opciones(comprar o vender ciertos recursos) y ejecuta la
	...
	private void realizeEconomy() {
		try {
			...
			switch (option) {
			case 1:
				sellOre(view.readDepartment(), view.readId(), view.readQuantityKilogram());
				break;
			case 2:
	 ...
	 * 
	 * @param department Departamento donde esta ubicada la mina que desea vender
	 *                   algun mineral.
	 * @param idMine     Numero de identificacion de la mina que desea vender algun
	 *                   mineral.
	 * @param kilos      Cantidad de Kg del mineral se desea vender.
	 */
	...
	/**
	 * Genera un menu y ejecuta los diferentes tipos de reportes graficos que se
	 * ofrecen al usuario.
	 * 
	 * @throws OptionInvalidException      Excepcion que se presenta cuando el
	 *                                     usuario ingresa una opcion que no es
	 *                                     valida.
	 * @throws DepartmentNotFoundException Excepcion que se presenta cuando cierto
	 *                                     departamento no ha sido encontrado o no
	 *                                     existe.
	 */
	...
	/**
	 * Metodo encargado de ofrecer a traves de un menu y generar los reportes que el
	 * usuario desee ver sobre precios.
	 * 
	 * @throws OptionInvalidException      Excepcion que se presenta cuando el
	 *                                     usuario ingresa una opcion que no es
	 *                                     valida.
	 ...
	 *                                     existe.
	 */
	private void selectReportPriceMines() throws OptionInvalidException, DepartmentNotFoundException {
	...
	/**
	 * Genera un reporte del valor total por kilogramo de todos los minerales en
	 * cada departamento.
	 */
	private void createReportPricePerDepartment() {
		view.showReportOne(model.generateReportPricePerDepartment(), IOManager.PRICE_GRAPHIC);
	}
	...
	private void createReportPriceMines() {
		...
		view.showReportOne(model.generateReportPricePerKilogram(0, data), IOManager.PRICE_GRAPHIC);
	}

	/**
	 * Genera un menu con los distintos reportes sobre la cantidad de minas, y
	 * ejecuta el que el usuario desee.
	 * 
	 * @throws DepartmentNotFoundException Excepcion que se presenta cuando cierto
	 *                                     departamento no ha sido encontrado o no
	 *                                     existe.
	...
	/**
	 * Genera un menu con los distintos reportes sobre las ganancias, y ejecuta el
	 * que el usuario desee.
	 * 
	 * @throws DepartmentNotFoundException Excepcion que se presenta cuando cierto
	 *                                     departamento no ha sido encontrado o no
	...
	/**
	 * Genera un menu con los distintos reportes sobre la extension de minas, y
	 * ejecuta el que el usuario desee.
	 * 
	 * @throws DepartmentNotFoundException Excepcion que se presenta cuando cierto
	 *                                     departamento no ha sido encontrado o no
	...
	private void createReportExtentionMinePerDepartment() throws DepartmentNotFoundException {
		Map<String, Integer> data = new HashMap<String, Integer>();
		view.showReportOne(model.generateReportm2PerDepartment(view.readDepartment(), 0, data), IOManager.M2_GRAPHIC);
	}
	...
	private void createReportGainPerMine() throws DepartmentNotFoundException {
		view.showReportOne(model.generateReportGainsPerMine(view.readDepartment()), IOManager.GAINS_GRAPHIC);
	}
	...
	private void createReportMinesPerDepartment() {
		view.showReportOne(model.generateReportMinesPerDepartment(), IOManager.NO_MINAS_GRAPHIC);
	}
	...
	private void createReportMinesPerOre() {
		view.showReportOne(model.generateReportMinesPerOre(), IOManager.NO_MINAS_GRAPHIC);
	}
	...
	private void createReportGainPerDepartment() {
		view.showReportOne(model.facadeGenerateReportGain(), IOManager.GAINS_GRAPHIC);
	}
	...
	private void createReportTypeMines() {
		Map<String, Integer> data = new HashMap<String, Integer>();
		view.showReportOne(model.generateReportQuantityTypeMines(data, 0), IOManager.NO_MINAS_GRAPHIC);
	}
	...
	private void createReportExtention() {
		view.showReportOne(model.generateReportM2perDepartment(), IOManager.M2_GRAPHIC);
	}
	...
	private void createReportMinesInColombia() {
		view.showReportOne(model.generateReportQuantityMinesInColombia(), IOManager.NO_MINAS_GRAPHIC);
	}
}