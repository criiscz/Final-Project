...
public class Mine {
	 ...
	 * @param meter         M2 de la mina.
	 * @param oreType       Tipo de mineral que explota la mina.
	 * @param kilogramPrice Valor por Kg del mineral.
	 * @param id            Numero de identificacion de la mina.
	 * @param mineType      Tipo de mina(Al aire libre/subterranea).
	 * @param budgetMine    Presupuesto de la mina.
	 */
	...
	public Object[] toObjectVector() {
		return new Object[] { id, name, meter, oreType.getOreType(), kilogramPrice, mineType.getMineType(),
				budgetMine };
	}
	 ...
	 * 
	 * @param oreType Nuevo tipo de mineral que se desea modificar en una mina.
	 */
	 ...
	 * 
	 * @param kilogramPrice Nuevo precio del mineral que se desea modificar en una
	 *                      mina.
	 */
	 ...
	 * 
	 * @param mineType Nuevo tipo de explotacion de cierta mina(al aire
	 *                 libre/subterranea).
	 */
	 ...
	 * @return Retorna el valor de la ganancia obtenida con la venta.
	 */
	 ...
	 * 
	 * @param value Valor total de los insumos a comprar.
	 * @return Retorna el dinero gastado del presupuesto de la mina.
	 */
	 ...
	 * 
	 * @return Retorna el valor de la ganancia de la mina.
	 */
	public int getGain() {
		return gain;
	}
